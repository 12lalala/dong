          ...
          <ul class="infinite-list"
            ...
            <li class="content-sub"
              ...
              <div class="content-sub1">
                ...
                <div class="word">
                  <span class="n1">
                    <router-link :to="'/article/announcement/' + article.articleid">{{article.title}}</router-link>
                  </span>
      ...
      articles: [
        {
          ...
          title: this.$t('Announce.articles.article5.title'),
          time: "2019-06-21",
          introduction: this.$t('Announce.articles.article5.introduction')
        },
        {
          articleid: "4",
          imgurl: require("../assets/newimages/1.png"),
          title: this.$t('Announce.articles.article4.title'),
          time: "2019-06-21",
          introduction: this.$t('Announce.articles.article4.introduction')
        },
        {
          articleid: "3",
          imgurl: require("../assets/newimages/1.png"),
          title: this.$t('Announce.articles.article3.title'),
          time: "2019-06-21",
          introduction: this.$t('Announce.articles.article3.introduction')
        },
        {
          articleid: "2",
          imgurl: require("../assets/newimages/1.png"),
          title: this.$t('Announce.articles.article2.title'),
          time: "2019-06-21",
          introduction: this.$t('Announce.articles.article2.introduction')
        },
        {
          articleid: "1",
          imgurl: require("../assets/newimages/1.png"),
          title: this.$t('Announce.articles.article1.title'),
          time: "2019-06-21",
          introduction: this.$t('Announce.articles.article1.introduction')
        },
      ],
    }
  },
